    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="public/upload/product/{{($pro_fea->product_feature_image)}}"
                        style='width:100px;height:100px' ; alt=""></td>
                <td>{{$pro_fea->product_feature_price}}</td>
                <td><?php
             if($pro_fea->product_feature_status==0){
               ?>
                    <a href="{{URL::to('/active-product-feature/'.$pro_fea->product_feature_id)}}"><span
                            class='fa-styling-off fa fa-toggle-on'></span></a>
                    <?php
              }else{
              ?>
                    <a href="{{URL::to('/unactive-product-feature/'.$pro_fea->product_feature_id)}}"><span
             ...
             ?>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{URL::to('/edit-product-feature/'.$pro_fea->product_feature_id)}}"><i
                                class="fa fa-pencil-square-o"></i></a>
                        <a onclick="return confirm('Are you sure you want to delete this item?');"
                            href="{{URL::to('/delete-product-feature/'.$pro_fea->product_feature_id)}}"><i
