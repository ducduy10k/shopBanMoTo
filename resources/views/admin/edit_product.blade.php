...
<form action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="product-descreption" name="product_descreption"
            rows="3">{{$pro->product_desc}}</textarea>
    </div>
    <div class="form-group">
        <label for="">Nội dung sản phẩm</label>
        <textarea class="form-control" id="product-content" name="product_content"
            rows="3">{{$pro->product_content}}</textarea>
    </div>
    <div class="form-group">
