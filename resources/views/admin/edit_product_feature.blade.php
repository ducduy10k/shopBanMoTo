...
<form action="{{URL::to('/update-product-feature/'.$edit_value->product_feature_id)}}" method="post" enctype='multipart/form-data'>
{{ csrf_field() }}
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="{{$edit_value->product_feature_id}}" id="product-feature-name" name="product_feature_name" >
  </div>
  
  
  <div class="form-group">
    <label for="">convert to HTML</label>
    <textarea class="form-control"  id="product-feature-value" name="product_feature_value" rows="3">{{$edit_value->product_feature_value}}</textarea>
  </div>
  <div class="form-group">
    <label for="">Hình ảnh sản phẩm</label>
    <input type="file" value="{{$edit_value->product_feature_image}}" class="form-control" id="product-feature-image" name="product_feature_image" >
    <img src="{{URL::to('public/upload/product/'.$edit_value->product_feature_image)}}" width='100' height='100' alt="">
  </div>
  <div class="form-group">
    <label for="">Giá sản phẩm</label>
    <input type="text" class="form-control" value="{{$edit_value->product_feature_price}}" id="product-feature-price" name="product_feature_price" >
  </div>
