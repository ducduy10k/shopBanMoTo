...
<form action="{{URL::to('/save-product-feature')}}" method="post" enctype='multipart/form-data'>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="product-feature-name" name="product_feature_name"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="product-feature-price" name="product_feature_price"
            placeholder="name@example.com">
    </div>
