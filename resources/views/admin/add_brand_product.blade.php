...
<form action="{{URL::to('/save-brand-product')}}" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="brand-product-name" name="brand_product_name"
            placeholder="name@example.com">
    </div>

    <div class="form-group">
        <label for="">Mô tả thương hiệu </label>
        <textarea class="form-control" id="brand-product-decreption" name="brand_product_decreption"
            rows="3"></textarea>
    </div>
